...
export const DeleteConfirmationDialog = ({setDialogIsOpened, dialogIsOpened, message, action}) => {

    const styles = useStyles()

    return <Dialog
        icon={<FaInfoCircle size={16} className={"bp3-icon material-icon"}/>}
        title={<span className={styles.dialogTitle}>Delete confirmation</span>}
        autoFocus={false}
        enforceFocus={false}
        ...
        style={{width: 450, height: 200, borderRadius: 2}}
