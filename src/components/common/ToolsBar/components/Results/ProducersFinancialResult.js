...
export const ProducersFinancialResult = ({financialResult, height, width}) => {
...
const getColumnWidth = (result) => {
    ...
    const columnWidth = [COLUMN_WIDTH + 150]
...
const getFinancialResultRows = (currency) => {
    return [
        {name: "Forecasted heat energy production amount", key: "GcalAmountProductionForecasted", measureUnit: "Gcal"},
        {name: "Heat energy production amount in fact", key: "GcalAmountProductionInFact", measureUnit: "Gcal"},
        {name: "Tariff", key: "totalMonthlyForecastedTariff", measureUnit: currency + "/Gcal"},
        {name: "Total forecasted costs", key: "totalMonthlyForecastedCosts", measureUnit: currency},
        {name: "Total costs in fact", key: "totalCostsInFact", measureUnit: currency},
        {name: "Total forecasted profit", key: "totalForecastedProducerProfit", measureUnit: currency},
